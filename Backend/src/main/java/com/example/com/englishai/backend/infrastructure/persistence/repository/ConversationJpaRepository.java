...
public interface ConversationJpaRepository extends JpaRepository<ConversationEntity,UUID> { List<ConversationEntity> findByUserIdOrderByUpdatedAtDesc(UUID userId); Optional<ConversationEntity> findByIdAndUserId(UUID id,UUID userId); }
